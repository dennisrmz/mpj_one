<div>
                        ...
                        >
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input tipoLentes" type="radio" name="<?php echo get_field('tipo_add_on'); ?>" id="<?php echo get_field('tipo_add_on') . "_" .  get_the_ID(); ?>" value="<?php the_ID(); ?>">
        ...
        <div style="display: flex; justify-content: flex-start; align-items: center; flex-direction: row; display:none; " id="tablaReceta">
            ...
            <style type="text/css">
                ...
                <tr>
                    ...
                    <td class="tg-0lax"><input type="number" name="OD_EST" id="od_TIPO"  style="width: 100%;">  </td>
                </tr>
                <tr>
    ...
    <div>
    <button type="button" id="anterior" class="btn btn-sm  btn-success"> Anterior </button>
    <button type="button" id="siguiente" class="btn btn-sm  btn-success"> Siguiente </button>
    </div>
