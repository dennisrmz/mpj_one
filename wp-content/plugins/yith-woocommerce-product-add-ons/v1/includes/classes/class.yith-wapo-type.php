...
if ( ! class_exists( 'YITH_WAPO_Type' ) ) {
	...
	class YITH_WAPO_Type {
		...
		public function save( $id = 0 ) {
			...
			$new_group_id                 = isset( $_POST['group_id'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_type                     = isset( $_POST['type'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			...
			$new_image                    = isset( $_POST['image'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_description              = isset( $_POST['description'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_operator                 = isset( $_POST['operator'] ) ?? 'OR'; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_depend                   = isset( $_POST['depend'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_depend_variations        = isset( $_POST['depend_variations'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_options                  = isset( $_POST['options'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_required                 = isset( $_POST['required'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_required_all_options     = isset( $_POST['required_all_options'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_collapsed                = isset( $_POST['collapsed'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_sold_individually        = isset( $_POST['sold_individually'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_first_options_free       = isset( $_POST['first_options_free'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_max_item_selected        = isset( $_POST['max_item_selected'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_minimum_product_quantity = isset( $_POST['minimum_product_quantity'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_max_input_values_amount  = isset( $_POST['max_input_values_amount'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_min_input_values_amount  = isset( $_POST['min_input_values_amount'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_change_featured_image    = isset( $_POST['change_featured_image'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_calculate_quantity_sum   = isset( $_POST['calculate_quantity_sum'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_step                     = isset( $_POST['step'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_priority                 = isset( $_POST['priority'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
