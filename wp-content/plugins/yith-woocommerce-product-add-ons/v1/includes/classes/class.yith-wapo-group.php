...
if ( ! class_exists( 'YITH_WAPO_Group' ) ) {
	...
	class YITH_WAPO_Group {
		...
		public function save( $id = 0 ) {
			...
			$new_vendor_id           = isset( $_POST['vendor_id'] ) ?? 0; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_products_id         = isset( $_POST['products_id'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_products_exclude_id = isset( $_POST['products_exclude_id'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_categories_id       = isset( $_POST['categories_id'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_attributes_id       = isset( $_POST['attributes_id'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_priority            = isset( $_POST['priority'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
			$new_visibility          = isset( $_POST['visibility'] ) ?? ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
